			...
			<div id = login_wrap>
				...
				<div id= login_container>
					...
					<label>
						...
						<input type="password"  tabindex="2" maxlength="16" name = "member_pw" id ="pass">
					</label>
					<br/>
					...
					<div id="hr"></div>
						<div>
							...
							<a href="http://localhost/ss/login/admin_login.do">관리자</a>
							</span><span>
							<a href="http://localhost/ss/login/join.do">회원가입</a>&emsp;
							<a href="http://localhost/ss/login/id_find.do">아이디찾기</a>&emsp;
							<a href="http://localhost/ss/login/pw_find.do">비밀번호찾기</a></span>
						</div>
				</div>
				</form>
			</div>
