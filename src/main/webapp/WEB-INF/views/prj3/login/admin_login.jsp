...
<style type="text/css">
	...
	#adminSt{display: flex;  justify-content: center; align-items: center; font-size: 20px}
...
function loginFail() {
	window.open("http://localhost/ss/login/fail.do","login_fail","width = 640, height = 387, top ="+(window.sceenTop+350)+",left =" +(window.creenleft + 600));
} 
			...
			<div id = login_wrap>
				...
				<div id= login_container>
					<label>
						...
						<input type="text" autofocus="autofocus" tabindex="1" maxlength="16" id="id" name="admin_id">
					</label>
					<br/>
					<label>
						<span id = "spanPw">비밀번호</span>
						<input type="password"  tabindex="2" maxlength="16" id="pass" name="admin_pw">
					</label>
					<br/>
