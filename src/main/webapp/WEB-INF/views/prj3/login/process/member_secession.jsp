...
<div class = "wrap">
	<div id="header">
		<form name = "check">
			...
			<div id = "text">
			<h4><strong style="font-size: 25px"><c:out value="${ param.id }"/></strong>님의 회원탈퇴가 완료되었습니다.</h4>
			</div>
			<div id="line"></div><br/>
				<div id = "btDiv">
					<button type="button" class="btn btn-danger btn-lg" style="margin-right: 10px" onclick="homeBt()">홈으로</button>
				</div>
		</form>
	</div>
</div>
