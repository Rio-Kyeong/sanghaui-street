    ...
    <!-- container start -->
        ...
        <!-- slider start -->
		    ...
		    <ul id="imgholder" class="imgs">
		        <li><img src="http://localhost/ss/common/images/2.jpg"></li>
		        <li><img src="http://localhost/ss/common/images/3.jpg"></li>
		        <li><img src="http://localhost/ss/common/images/4.jpg"></li>
		        <li><img src="http://localhost/ss/common/images/5.jpg"></li>
		    </ul>
		    <div class="bullets">
		...
		<table>
			...
			<c:forEach var="top" items = "${ topList }">
				<c:if test="${ cnt < 4 }">
					<td>
						<input type="hidden" value = "${top.prod_num }"/>
						<a href="http://localhost/ss/product/prod_detail.do?prod_num=${top.prod_num }">
						<img src="http://localhost/ss/common/product_photo/${top.prod_image}" class="item"/>
						</a>
			...
			<c:forEach var="bot" items = "${ botList }">
				<c:if test="${ cnt < 4 }">
					<td>
						...
						<img src="http://localhost/ss/common/product_photo/${bot.prod_image}" class="item"/>
						</a>
						<c:set var="cnt" value="${ cnt+1 }"/>
					</td> 		
				</c:if>
