...
<div id="wrap">
	...
	<h1 id="headerTitle">SANGHAUI STREET ADMINISTRATOR</h1>
		<h1 id="title" >상품 정보</h1>
				<form enctype="multipart/form-data"  id="prod_updateFrm" name="prod_updateFrm" method="post" action="admin_prodMod_proc.do">
			...
			<a href="http://localhost/ss/admin/admin_prodDel_proc.do?prod_num=${prodInfo.prod_num}">
				<input type="button" id="btnDel"value="삭제" class=" btn btn-group-lg" style="position:relative;left:1400px;bottom:400px;"/>
			</a>	
				</form>
